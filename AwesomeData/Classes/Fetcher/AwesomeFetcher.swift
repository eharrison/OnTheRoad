...
extension AwesomeFetcher {
     ...
     *   @param completion: Returns fetched NSData in a block
     */
    public static func fetchData(_ urlString: String?, completion:@escaping (_ data: Data?) -> Void) -> URLSessionDataTask?{
        return fetchData(urlString, method: .GET, bodyData: nil, headerValues: nil, shouldCache: false, timeoutAfter: 0, completion: completion)
    }
